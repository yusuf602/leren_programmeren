...
class story:
    ...
    def finish(self):
        ...
        if self.route.roomanswers.count(dungeon.rooms.DEFAULT_ROOM_ANSWER) > 0:
            ...
            result = 'rescued'
        elif self.route.get_last_answer() == True:
            self.write(f'Je hebt de juiste deurcode niet ingevoerd, maar door jouw snelle denken ben je toch ontsnapt.')
            result = 'forced'
    ...
    def proccess_attempt(self, dungeon_result:str):
        ...
        elif dungeon_result in ['cheated', 'rescued', 'forced']:
